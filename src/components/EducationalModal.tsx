        ...
        <Stack gap="xs">
          ...
          <Paper p="sm" radius="md" style={{ backgroundColor: '#faf5ff', border: '1px solid #f3e8ff' }}>
            ...
            <Text size="xs" c="#581c87" lh={1.5}>
              ขั้นตอนการฟอกเลือดหรือล้างไตจะสูญเสียโปรตีนไปกับกระบวนการ ผู้ที่อยู่ในระยะนี้จึงต้องทานโปรตีนคุณภาพสูง (ไข่ขาว, ปลา) เพิ่มขึ้นเป็น 1.2 - 1.4 กรัม/กก./วัน แต่ยังต้องคุมฟอสฟอรัสและน้ำอย่างเคร่งครัด
            </Text>
          </Paper>
        </Stack>

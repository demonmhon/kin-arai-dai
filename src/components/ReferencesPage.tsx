...
export const ReferencesPage: React.FC<ReferencesPageProps> = ({
  ...
  const sources = [
    ...
    },
    {
      ...
      description:
        'ศูนย์รวมความรู้ด้านโภชนบำบัดและการแพทย์เชิงปฏิบัติ ให้ข้อมูลที่เข้าใจง่ายสำหรับผู้ดูแลและผู้ที่ต้องการปรับโภชนาการตามภาวะสุขภาพในชีวิตประจำวัน',
    },
    {
        ...
        <Stack gap="xl">
          ...
          <Box>
            ...
            <Text size="sm" c="dimmed" style={{ maxWidth: 780 }} lh={1.7}>
              เว็บไซต์ "กินอะไรได้" รวบรวมข้อมูลโภชนาการจากเอกสารทางการแพทย์ คู่มือเวชปฏิบัติ
          ...
          >
            ...
            <Text size="xs" c="#047857" lh={1.7}>
              ...
              <br />
              เนื่องจากสภาวะร่างกายของแต่ละท่านแตกต่างกัน มีภาวะสุขภาพเฉพาะบุคคล และมีผลตรวจเลือดเฉพาะบุคคล
          ...
          <Paper p="xl" radius="xl" withBorder style={{ backgroundColor: '#ffffff', borderColor: '#e2e8f0' }}>
            <Title order={3} fz={{ base: 16, sm: 18 }} fw={700} c="slate.9" mb="xs">
              เกณฑ์การคัดกรองข้อมูลของ "กินอะไรได้"
            </Title>
